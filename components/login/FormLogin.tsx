...
export default function FormLogin() {
  ...
  return (
    <section className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-(--color-brand-beige)">
      {/* COLONNA IMMAGINE */}
      <div className="hidden lg:block relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-(--color-brand-green)" />
        ...
        <div className="absolute inset-x-0 bottom-0 p-12">
          <div className="max-w-md rounded-4xl bg-white/85 p-8 backdrop-blur-sm">
            ...
            <h1 className="section-title-black tracking-[-0.03em] mt-4 text-4xl leading-tight font-semibold text-(--color-brand-green)">
      ...
      <div className="flex items-center justify-center px-5 py-10 md:px-8 lg:px-16">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between gap-4">
                ...
                <a
                  href="#"
                  className="text-sm font-medium text-(--color-brand-green) hover:underline"
                >
            ...
            <button
              type="submit"
              className="btn-primary mt-2 flex w-full items-center justify-center rounded-2xl bg-(--color-brand-dark) px-6 py-3.5 text-sm font-semibold uppercase tracking-[0.12em] text-white transition hover:bg-(--color-brand-green)"
            >
              Accedi
            </button>
          </form>
          ...
          <p className="mt-8 text-center text-sm text-neutral-600">
            ...
            <a
              href="#"
              className="font-semibold text-(--color-brand-green) hover:underline"
            >
              Registrati
            </a>
          </p>
