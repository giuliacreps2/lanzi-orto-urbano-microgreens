...
import file from "@/public/hero-microgreens-freschi-italia.webp";
...
export const heroContent: HeroContent = {
  ...
  description:
    "Coltiviamo microgreens di qualità superiore in ambiente controllato, con cura artigianale e rispetto per l'ambiente.",
  image: {
    src: file.src,
